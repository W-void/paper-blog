...
![](../static/img/wechat/7d3e2742-083e-4b08-8180-6c15216beec6-bdf6e8.webp)

之前介绍过快手的OneSug，这次同一团队又出品了OneSearch，相似的业务背景、方法思想、行文结构，联合食用更佳。

本文模型的主体结构和OneRec类似，其他部分提出了很多搜索业务的方案，而且这篇文章给出的细节非常多，还是建议阅读原文。
![](../static/img/wechat/b4ebbe08-dc58-423a-a287-f1b199ae0f21-dacadf.webp)
...
![](../static/img/wechat/a23733c8-960d-4e18-a62b-da4ca9f21d80-45816e.webp)

![](../static/img/wechat/b46b3fd4-eba0-43ec-bb36-31f712b375c5-843c4f.webp)
...
![](../static/img/wechat/05f55484-5002-44c3-a19d-92a74379f30d-411804.webp)

模型分为4个部分：SID、多视角行为序列、模型结构（encoder-decoder）、偏好对齐。

# 2.1 SID

![](../static/img/wechat/b6d1bf5b-b04c-4c36-bfd2-5f7a955d5c4c-ca19de.webp)

1. 语意向量生成。和OneSug一样，先用BGE语言模型生成query和item的初始emb。然后进行语意对齐，损失有: i2i、q2q、q2i的对比损失、q2i的margin loss 和 难样本的相关性loss，相关性标签由LLM得到。
  ![](../static/img/wechat/0cb23bde-41b4-4036-9a75-cee11216d376-99b7f1.webp)
2. 语意向量增强。item的文本往往会有一些和item无关但能加曝光度的一些文本，比如OneSug用相关query对prefix进行增强，本文用top keyward对item的keyward进行增强。具体来说，提取了18种keyward类型，每种类型的keyward都选择pv最高的几个组成core keyword表，然后进行增强。
  ![](../static/img/wechat/8ea0421f-46f3-4dec-ab58-782916ceedf4-1662e3.webp)
...
![](../static/img/wechat/399336e6-15b4-451f-bb6c-c6af9bbc14d2-b60f56.webp)

而且这个OPQ好像只适合量化最后一层的残差，用OPQ替代前面的RQ-Kmeans，效果下降很明显。
![](../static/img/wechat/0d68b49e-d733-4514-a14f-54e65dd2939a-126023.webp)

## 2.2 多视角行为序列

![](../static/img/wechat/e2d3dfce-7c2c-4506-a33a-bed213cd0c0e-9b4047.webp)

1. 用户SID。 由长短序列提取，长度为m的短期点击序列、长度为n的长期下单序列，再加上一个时间衰减系数，所以用户SID的长度为10：
  ![](../static/img/wechat/69dcdc40-8663-4131-ae52-17e7326c2f06-2a80c4.webp)
...
3. 长期行为，包括点击行为、下单行为、搜索相关行为，经过3层RQ编码后，对每一层RQ聚合，再做QFormer，得到长期行为表征，输入到下游模型中：
  ![](../static/img/wechat/e25ae4bb-49ce-44bb-becd-995da7d7c49f-39524e.webp)
...
![](../static/img/wechat/f38f2f1a-232a-49c8-955b-3858e7350331-2c2f41.webp)
...
![](../static/img/wechat/cc072e9c-14a3-4d27-ae83-be5e847a3a7b-c45f53.webp)

和OneSug一样，将用户行为分为6个等级。
![](../static/img/wechat/5ebaa412-aeea-407f-b3c7-d6ee23640684-c3f6bf.webp)

reward要综合考虑曝光、点击、下单，计算公式为：
![](../static/img/wechat/a62d9fbe-cd6e-4121-a8fc-056ffbe6445c-63529c.webp)

2. 奖励模型训练。

![](../static/img/wechat/308ec782-de11-4230-9862-a5eb69281e61-d2e0e6.webp)
...
![](../static/img/wechat/828b9733-de5c-46b5-b933-6f4d71e1e0ce-886949.webp)
...
离线实验：
![](../static/img/wechat/52c6f9fc-1f07-42f2-8f1a-4db9cabe1476-93c28a.webp)

在线实验：
![](../static/img/wechat/2b2841c7-e440-422d-8b5b-203fb17c3585-681aa4.webp)

MFU从3.26%提升到27.32%，推理成本（operational expenditure，OPEX）下降了75.4%！
![](../static/img/wechat/b846be6d-56bc-4633-ad63-584dd5a4969f-41aabc.webp)

而且不像OneRec-v2对冷启物料不友好，OneSearch对长尾query仍然有效！
![](../static/img/wechat/43d9dea9-09f2-410a-9714-3789438149f5-e95b70.webp)

![](../static/img/wechat/df6e6256-150f-4a62-b911-e182b7aeb8b1-0d3336.webp)
